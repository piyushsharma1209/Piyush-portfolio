...
const Skills = () => {
    return (
        <section id="skills">
            ...
            <span className="skillDesc">Jeg heter Piyush Sharma, og jeg er en snart uteksaminert student innen front-end utvikling hos Noroff. Jeg er svært motivert for å begynne karrieren min og ønsker å bidra til å utvikle innovative løsninger hos dere. <br /><br />
